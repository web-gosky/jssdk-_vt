...
<html class="no-js">
	<head>
		...
		<link rel="stylesheet" href="{{ $assets_path_res }}css/data.css">

	</head>
	<body class="g-document-blue-bg">
		<img src="{{ $assets_path }}images/1-auth-01.png" class="am-img-responsive full-width" alt="4-document-01-01.png" />
		<div class="am-g am-margin-top-sm">
			<div class="d_content">
				...
				<div class="d_wrop">
					<div class="iphone">
						昵称
						<input id="d_name" class="d_name" type="text" value="{{ isset($children['nickname']) ? $children['nickname'] : '' }}" maxlength="11" placeholder="妹妹蓝">
					</div>
					<div class="text" style="position: relative;">
						生日
						<input id="d_date"  class="d_name" type="date" maxlength="4" placeholder="2016-12-1" value="{{ isset($children['birthday']) ? $children['birthday'] : '' }}">
						<div id="d_display">
							请选择生日
						</div>
					</div>
					<div class="sex">
						性别
						<div class="d_nei">
							<span class="d_man active" js_sex="1" style="background-color: rgb(41, 171, 226);">
								<img src="{{ $assets_path }}images/man.png">
								男孩</span><span class="d_women"  js_sex="2">
								<img src="{{ $assets_path }}images/women.png">
								女孩</span>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="{{ $assets_path_res }}js/jquery.min.js">
	</script>
	<script type="text/javascript" src="{{ $assets_path_res }}js/login.js">
	</script>
