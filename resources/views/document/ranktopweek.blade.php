...
<body class="g-document-blue-bg">
    <img src="{{ $assets_path }}images/4-document-02-01.png" class="am-img-responsive full-width" alt="4-document-02-01.png"/>
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-02-02.png" class="am-img-responsive full-width" alt="4-document-02-02.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-02-03.png" class="am-img-responsive full-width" alt="4-document-02-03.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
