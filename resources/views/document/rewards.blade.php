   ...
   <img src="http://test.open.vitabee.cn/assets/images/dev.png" class="am-img-responsive full-width" alt="4-document-01-01.png">
    ...
    <div class="am-g am-margin-top-sm">
        <div class=" am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/ruhe.png" class="am-img-responsive full-width" alt="4-document-01-02.png"/>
        </div>
    </div>
...
<div class="am-g am-margin-top-sm">
    ...
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-02-05.png" class="am-img-responsive full-width" alt="4-document-02-05.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
