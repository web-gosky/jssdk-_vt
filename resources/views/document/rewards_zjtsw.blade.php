...
<body class="g-document-blue-bg">
   <img src="http://test.open.vitabee.cn/assets/images/dev.png" class="am-img-responsive full-width" alt="4-document-01-01.png">
   	<div class="d_resetWidth">
   		

   	
    <div class="am-g am-margin-top-sm">
        <div class=" am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/ruhe1.png" class="am-img-responsive full-width" alt="4-document-01-02.png"/>
            <p style="color: #fff;text-align: center;font-size: 13px;margin-top: -22px;">如有疑问,可关注"青春浙江"公众号咨询详情</p>
        </div>
    </div>
    <div class="am-g am-margin-top-sm am-margin-top-md" style="    margin-top: 35px;">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-01-03.png" class="am-img-responsive full-width" alt="4-document-01-03.png"/>
                ...
                <div class="am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2" style="color: #fff;text-align: center;font-size: 13px;">
        	根据	阅读力量排位获得相应奖励
        </div>
    </div>
    <div class="am-g am-margin-top-sm">
    ...
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/zb1_zjtsw.png" class="am-img-responsive full-width" alt="4-document-01-05.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/zb2_zjtsw.png" class="am-img-responsive full-width" alt="4-document-01-06.png"/>
        </div>
    </div>
<div class="am-g am-margin-top-sm">
    ...
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-02-04.png" class="am-img-responsive full-width" alt="4-document-02-04.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/zb3_zjtsw.png" class="am-img-responsive full-width" alt="4-document-02-05.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-02-06.png" class="am-img-responsive full-width" alt="4-document-02-06.png"/>
        </div>
    </div>
    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
        <div class="am-u-sm-10 am-u-sm-offset-1 am-u-md-8 am-u-md-offset-2">
            <img src="{{ $assets_path }}images/4-document-02-07.png" class="am-img-responsive full-width" alt="4-document-02-07.png"/>
        </div>
    </div>
       	</div>
    <!--在这里编写你的代码-->
